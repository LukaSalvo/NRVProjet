...
class DisplaySpectacleDetailAction extends Action {
    ...
    public function execute(): string {
        ...
        <div class="container mx-auto p-6 bg-gray-100 rounded-lg shadow-lg">
            ...
            <p class="text-lg"><strong>Date :</strong> ' . htmlspecialchars($spectacle['date']) . '</p>
            <p class="text-lg"><strong>Lieu :</strong> ' . htmlspecialchars($spectacle['nom_lieu']) . '</p>
        ...
        // Récupération des sections similaires
